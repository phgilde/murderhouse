    ...
    public String interact(Optional<Item> heldItem) {
        if (heldItem.isPresent()) {
            if (heldItem.get().getName().equals("gruener schluessel")) {
                return "Der Schrant beginnt sich ploetzlich zu bewegen und du schreckst zurueck. *Es oeffnet sich eine Tuer zu einem Geheimzimmer*, dass du nun betreten kannst.";
            }
