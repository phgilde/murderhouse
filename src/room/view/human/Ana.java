...
public class Ana extends Human {
    ...
    public String talk(Optional<Item> heldItem) {
        if (heldItem.isEmpty()) {
            return "'Ich weiß gar nicht was ich denken soll! Der arme Mann ist einfach Tod!'"
                    + "'Das tut mir ja wahnsinnig leid für ihn. Und er hatte gerade erst einen |Streit| mit beiden Kindern. Ach gottchen'";
