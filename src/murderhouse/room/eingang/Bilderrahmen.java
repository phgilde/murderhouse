...
public class Bilderrahmen extends View {
    ...
    public Bilderrahmen() {
        items.put("oelgemaelde", new SimpleItem("Oelgemaelde",
                "Eine weiss bemalte Leinwand. Auf der Leinwand ist ein Schneesturm zu sehen. "
    ...
    public String getDescription() {
        if (items.containsKey("oelgemaelde"))
            return "Ein Oelgemaelde. Du kannst zunaechst nicht erkennen, was es zeigt. Auf einer bronzenen Plakette unter dem Rahmen steht: 'Der Schneesturm'."
                    + " Nachdem du das Gemaelde erneut ansiehst, erkennst du wirklich einen Schneesturm, denn das gesamte Bild ist in Weiss gehalten.";
        else
